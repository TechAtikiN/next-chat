    ...
    <footer className='bg-slate-900'>
      <div className='w-full max-w-screen-2xl mx-auto p-10 lg:py-8'>
          ...
          <div className='grid sm:grid-cols-4 grid-cols-2 sm:gap-x-10 sm:gap-y-0 gap-y-7 '>
            <div className=''>
              ...
              <ul className='text-gray-400 space-y-5 font-medium'>
                <li className=''>
                  <Link href='/' className='hover:underline'>Language Translation</Link>
                </li>
                <li>
                  <Link href='/' className='hover:underline'>Manage Subscription</Link>
                </li>
                <li>
                  <Link href='/' className='hover:underline'>Real-time Chat</Link>
                </li>
                <li>
                  <Link href='/' className='hover:underline'>Dark Mode</Link>
                </li>
              </ul>
            </div>
            ...
            <div className=''>
              ...
              <ul className='text-gray-400 space-y-5 font-medium'>
                ...
                <li>
                  <Link href='/' className='hover:underline'>Stripe</Link>
                </li>
            ...
            <div className=''>
              <h2 className='mb-4 text-sm font-bold text-gray-300 uppercase'>New tech?</h2>
              <ul className='text-gray-400 space-y-5 font-medium'>
                <li className=''>
                  <Link href='/' className='hover:underline'>Firebase Rules</Link>
                </li>
                <li>
                  <Link href='/' className='hover:underline'>Firebase Extensions</Link>
                </li>
                <li>
                  <Link href='/' className='hover:underline'>Stripe Subscriptions</Link>
                </li>
              </ul>
            </div>
        ...
        <div className=''>
          <div className='flex justify-between items-center'>
            <div className='text-gray-300 text-left sm:flex sm:justify-between sm:space-y-1 space-y-4'>
              <p className='text-lg font-semibold'>
                Want to explore more features, get started today and subscribe to PRO for more features!
              </p>
            </div>
          ...
          <p className='text-gray-400 text-sm sm:py-0 py-5'>The most amazing chat application!</p>
        ...
        <div className='flex justify-between'>
          <p className='text-sm text-center text-gray-400 sm:text-center'>
            © 2023 <Link href='/' className='hover:underline'>NextChat</Link>. All Rights Reserved.
          </p>
