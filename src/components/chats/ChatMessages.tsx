...
// named imports
import { Message, sortedMessagesRef } from '@/converters/Message'
  ...
  return (
    <div className='p-5'>
      {!loading && messages?.length === 0 && (
        <div
          className='flex flex-col justify-center items-center text-center p-20 rounded-xl space-y-2 bg-indigo-400 text-white font-extralight'>
          ...
          <p>The AI will autodetect and tranlate it all for you</p>
        </div>
      )}
      ...
      {messages?.map((message) => {
        ...
        return (
          ...
          >
            <div
              className={`flex flex-col relative space-y-1 p-2 text-sm w-fit line-clamp-1 mx-3 rounded-lg
                ${isSender
